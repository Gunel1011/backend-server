...
const addProduct = async (req, res) => {
  ...
  upload(req, res, async (err) => {
    ...
    const { name, details, price, for_slide } = req.body;
    ...
    try {
      const newProduct = new Product({
        ...
        details,
        price,
        for_slide: for_slide === 'true' || for_slide === true,
...
const updateProduct = async (req, res) => {
  ...
  upload(req, res, async (err) => {
    ...
    try {
      ...
      product.for_slide = for_slide !== undefined ? (for_slide === 'true' || for_slide === true) : product.for_slide;
